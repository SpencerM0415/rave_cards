...
import { Card, CollapsibleSection, ProductGallery, PackTypePicker } from "@/components";
import { Heart, ShoppingBag, Star } from "lucide-react";
import PackTypeSwatches from "@/components/PackTypeSwatches";
import { getProduct, getProductReviews, getRecommendedProducts, type Review, type RecommendedProduct } from "@/lib/actions/product";

type GalleryVariant = { packType: string; images: string[] };
...
export default async function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const galleryVariants: GalleryVariant[] = variants.map((v) => {
        ...
        return {
            packType: v.packType?.name || "Standard",
    ...
    const subtitle = "Trading Card Pack";
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_480px]">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <CollapsibleSection title="Pack Contents">
                        <p>Each pack contains a random selection of trading cards. Pack contents may vary by type (Standard, Deluxe, Premium, etc.).</p>
                    </CollapsibleSection>

                    <CollapsibleSection title="Shipping & Returns">
                        <p>Free standard shipping on orders over $25 and free 30-day returns for registered customers.</p>
                    </CollapsibleSection>
