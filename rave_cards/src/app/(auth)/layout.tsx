            ...
            <section className="hidden lg:flex flex-col justify-between bg-dark-900 text-light-100 p-10">
                <div className="flex items-center">
                    <div className="h-20 w-20 rounded-md bg-orange inline-flex items-center justify-center">
                        <Image src="/logo.png" alt="FTC Logo" width={80} height={80} />
                    </div>
                </div>

                <div className="space-y-4">
                    <h2 className="text-heading-2">Festival Trading Cards</h2>
                ...
                <p className="text-footnote text-light-400">© 2025 Festival Trading Cards. All rights reserved.</p>
            </section>
