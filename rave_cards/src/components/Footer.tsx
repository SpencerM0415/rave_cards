...
const columns = [
    {
        title: "Featured",
        links: ["Pack 1", "Pack 2", "Pack 3", "Pack 4"],
    },
    {
        title: "Lost Lands",
    ...
    {
        title: "Tomorrowland",
        links: ["Card 1", "Card 2", "Card 3", "Card 4", "Card 5"],
    },
    {
        title: "Electric Forest",
        links: ["Card 1", "Card 2", "Card 3", "Card 4", "Card 5", "Card 6"],
    },
] as const;
            ...
            <div className="border-t border-white/10">
                <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-4 text-light-400 sm:flex-row sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3 text-caption">
                        ...
                        <span>USA</span>
                        <span>© 2025 RaveCards, Inc. All Rights Reserved</span>
                    </div>
                    <ul className="flex items-center gap-6 text-caption">
                        {["Guides", "Terms of Sale", "Terms of Use", "RaveCards Privacy Policy"].map((t) => (
                            <li key={t}>
                                <Link href="#">{t}</Link>
                            </li>
                        ))}
