...
CREATE TABLE "pack_types" (
	...
	"sort_order" integer DEFAULT 0 NOT NULL,
	CONSTRAINT "pack_types_slug_unique" UNIQUE("slug")
);
--> statement-breakpoint
...
ALTER TABLE "product_variants" ADD CONSTRAINT "product_variants_pack_type_id_pack_types_id_fk" FOREIGN KEY ("pack_type_id") REFERENCES "public"."pack_types"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
